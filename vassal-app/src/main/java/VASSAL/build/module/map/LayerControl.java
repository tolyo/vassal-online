...
public class LayerControl extends AbstractToolbarItem implements ComponentDescription {
  ...
  public static final String CMD_TOGGLE =
      "Switch Layer between Active and Inactive"; // NON-NLS - yes, really
  ...
  protected static final String[] COMMANDS = {
    CMD_ROTATE_UP, CMD_ROTATE_DN, CMD_ENABLE, CMD_DISABLE, CMD_TOGGLE, CMD_RESET
  };
  ...
  public String[] getAttributeNames() {
    return ArrayUtils.addAll(super.getAttributeNames(), DESCRIPTION, COMMAND, SKIP, LAYERS);
  }
