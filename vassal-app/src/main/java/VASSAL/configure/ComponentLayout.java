...
public class ComponentLayout extends TraitLayout {
  ...
  public static final String DEFAULT_COMPONENT_LAYOUT_CONSTRAINTS =
      COMPONENT_INSETS + "," + STANDARD_GAPY + ",hidemode 3,wrap 2"; // NON-NLS
  public static final String DEFAULT_COMPONENT_COLUMN_CONSTRAINTS =
      "[right]rel[fill,grow]"; // NON-NLS
