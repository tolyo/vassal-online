...
public class AudioClipConfigurer extends FileConfigurer {
  ...
  //
  // The AudioClipConfigure can take an Expression as well as a straight file name, while the super
  // class
  ...
  public Component getControls() {
    if (p == null) {
      p =
          new ConfigurerPanel(
              getName(), "[]rel[grow,fill,push]1[]", "[]rel[]rel[grow,fill,push]1[]"); // NON-NLS
      ...
      p.add(tf, "grow");
      button =
          new FormattedExpressionConfigurer.ExpressionButton(
              this, tf.getPreferredSize().height, sourcePiece);
      p.add(button);
