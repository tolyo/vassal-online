...
/**
 * An {@link ImageOp} which scales its source and cobbles scaled tiles from the tile cache.
 *
 * @since 3.2.0
...
public class ScaleOpTiledBitmapImpl extends ScaleOpBitmapImpl {
  ...
  protected ImageOp createTileOp(int tileX, int tileY) {
    ...
    final boolean invPow2 =
        Math.floor(iscale) == iscale && (((int) iscale) & (((int) iscale) - 1)) == 0;
