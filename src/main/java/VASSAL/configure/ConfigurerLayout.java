...
public class ConfigurerLayout extends MigLayout {
  ...
  public static final String STANDARD_INSETS_GAPY =
      STANDARD_INSETS + "," + STANDARD_GAPY; // NON-NLS

  @Deprecated(since = "2023-10-16", forRemoval = true)
  public static final String STANDARD_INSERTS_GAPY =
      STANDARD_INSETS + "," + STANDARD_GAPY; // NON-NLS

  public static final String DEFAULT_CFG_LAYOUT_CONSTRAINTS =
      STANDARD_INSETS + ",hidemode 3"; // NON-NLS

  /**
   * Create a Layout with alternate Column constraints depending on whether or not a label is
   * supplied for this configurer New-style Configurers will always supply a blank label. Legacy
   * style Configurers will supply a text label and the column constraints must included a column
   * for this.
   *
  ...
  public ConfigurerLayout(String name, String noNameColConstraints, String nameColConstraints) {
    this(
        ...
        (name == null || name.isEmpty()) ? noNameColConstraints : nameColConstraints);
  }
