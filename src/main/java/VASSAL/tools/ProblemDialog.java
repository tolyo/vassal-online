...
public class ProblemDialog {
  ...
  public static Future<?> show(
      int messageType, Component parent, String messageKey, Object... args) {

    return show(messageType, parent, null, messageKey, args);
  }

  public static Future<?> show(
      int messageType, Throwable thrown, String messageKey, Object... args) {

    return show(messageType, getFrame(), thrown, messageKey, args);
  }

  public static Future<?> show(
      int messageType, Component parent, Throwable thrown, String messageKey, Object... args) {
  ...
  public static Future<?> show(
    ...
    return DialogUtils.enqueue(
        () -> Dialogs.showMessageDialog(parent, title, heading, message, messageType));
  }

  public static Future<?> showDisableable(
      int messageType, Object key, String messageKey, Object... args) {

    return showDisableable(messageType, getFrame(), null, key, messageKey, args);
  }

  public static Future<?> showDisableable(
      int messageType, Component parent, Object key, String messageKey, Object... args) {

    return showDisableable(messageType, parent, null, key, messageKey, args);
  }

  public static Future<?> showDisableable(
      int messageType, Throwable thrown, Object key, String messageKey, Object... args) {

    return showDisableable(messageType, getFrame(), thrown, key, messageKey, args);
  }
  ...
  public static Future<?> showDetails(
      int messageType, String details, String messageKey, Object... args) {

    return showDetails(messageType, getFrame(), null, details, messageKey, args);
  }

  public static Future<?> showDetails(
      int messageType, Component parent, String details, String messageKey, Object... args) {

    return showDetails(messageType, parent, null, details, messageKey, args);
  }

  public static Future<?> showDetails(
      int messageType, Throwable thrown, String details, String messageKey, Object... args) {

    return showDetails(messageType, getFrame(), thrown, details, messageKey, args);
  }
  ...
  public static Future<?> showFileOverwriteFailure(
    ...
    return showFileOverwriteFailure(messageType, getFrame(), thrown, details, messageKey, args);
  }
  ...
  public static Future<?> showFileOverwriteFailure(
    ...
    return showDetails(
        ...
        details,
        Resources.getString(
            messageKey + "_title", thrown.getFile(), thrown.getOtherFile(), args), // NON-NLS
        Resources.getString(
            messageKey + "_heading", thrown.getFile(), thrown.getOtherFile(), args), // NON-NLS
        Resources.getString(
            messageKey + "_message", thrown.getFile(), thrown.getOtherFile(), args) // NON-NLS
        );
  }
  ...
  public static Future<?> showDetailsDisableable(
      int messageType, String details, Object key, String messageKey, Object... args) {

    return showDetailsDisableable(messageType, getFrame(), null, details, key, messageKey, args);
  }
  ...
  public static Future<?> showDetailsDisableable(
    ...
    return showDetailsDisableable(messageType, getFrame(), thrown, details, key, messageKey, args);
  }
