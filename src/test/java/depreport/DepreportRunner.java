...
public class DepreportRunner {
  ...
  private static final String UNUSED_DEPENDENCIES =
      "src/test/resources/depreport/unused-dependencies.txt";

  /**
   * Meant to be used manually to rewrite the list of unused dependencies based on the list of
   * deprecated class features and the dependency report.
   *
   * <p>Do not commit without active @Ignore annotation.
   */
  @Disabled
  @Test
