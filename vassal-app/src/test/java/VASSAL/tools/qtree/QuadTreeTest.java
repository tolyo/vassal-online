...
public class QuadTreeTest extends junit.framework.TestCase {
  ...
  public void testBalancing() {
    ...
    assertEquals("Root should be a leaf node.", QNodeType.LEAF, root.getNodeType());
    assertTreesChildrenAreNull(qt);
    ...
    assertEquals("Root should now be a pointer.", QNodeType.POINTER, root.getNodeType());
    ...
    assertEquals(
        "Root should have been rebalanced and be a leaf node.", QNodeType.LEAF, root.getNodeType());
    assertTreesChildrenAreNull(qt);
    assertEquals("first", root.getPoint().getValue());
  }
