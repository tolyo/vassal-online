...
public interface PropertyExporter extends PropertyNameSource, PropertySource {
  ...
  default Map<String, Object> getProperties() {
    ...
    if (this instanceof GamePiece) {
      PieceAccess.GlobalAccess
          .hideAll(); // Force masked pieces to be hidden from me to generate correct masked name
  ...
  /**
   * Update an existing Map of Properties and return the Map. Do not overwrite the value if a
