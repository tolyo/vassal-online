...
/**
 * When invoked, will request synchronization info from another player - Cannot Synch when in the
 * default room - Cannot Synch with a player in a different room - Cannot Synch with yourself -
