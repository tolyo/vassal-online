...
/**
 * A set of global preferences shared by all modules. This superclass exists primarily to make sure
 * that the Global Preferences file gets written whenever a preference setting is changed.
 */
public class GlobalPrefs extends Prefs {
  private boolean disableAutoWrite =
      false; // If our auto-write function has been temporarily disabled
  ...
  /**
   * Adds the preference, and adds a listener for property changes, so that global preference file
   * will be automatically written after any change.
   *
