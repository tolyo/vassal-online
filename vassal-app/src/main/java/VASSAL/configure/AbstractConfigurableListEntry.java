 ...
 *
 * <p>A {@link ConfigurableListEntry} must be configurered by a single Configurer.
 */
public abstract class AbstractConfigurableListEntry implements ConfigurableListEntry {
    ...
    if (removeButton == null) {
      removeButton =
          new NoInsetButton(
              "no",
              iconSize,
              "Editor.ConfigurableListEntryController.remove_button_tip"); // NON-NLS
  ...
  /**
   * Update the visibility of any optional components in this entry Most Configurer entries will not
   * have option components.
   */
  @Override
  public void updateVisibility() {}

  /**
   * Set the Highlighted status of fields in this entry. Used to highlight the currently selected
   * entry.
   *
