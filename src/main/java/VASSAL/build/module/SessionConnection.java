 ...
 */
/** Represents a live multiplayer session connection independent of any specific chat UI. */
public interface SessionConnection {
  ...
  /** Send a command to other players in the session. */
  ...
  /**
   * Register a PropertyChangeListener. Changes to connection status trigger a PropertyChangeEvent,
