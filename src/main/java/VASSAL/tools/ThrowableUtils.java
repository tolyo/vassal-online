...
public class ThrowableUtils {
  ...
  /**
   * Returns the most recent {@link Throwable} of class <code>T</code> in the proper causal history
   * of the given <code>Throwable</code>, if one exists.
   *
   * @param cl the {@link Class} to search for
   * @param t the <code>Throwable</code> to check
   * @return the proper ancestor of class <code>T</code>, or <code>null</code> if none exists
   */
  ...
  /**
   * Returns the most recent {@link Throwable} of class <code>T</code> in the (not necessarily
   * proper) causal history of the given <code>Throwable</code>, if one exists. If the given <code>
   * Throwable</code> is of class <code>T</code>, it will be returned.
   *
   * @param cl the {@link Class} to search for
   * @param t the <code>Throwable</code> to check
   * @return the ancestor of class <code>T</code>, or <code>null</code> if none exists
   */
  ...
  /**
   * Throws the most recent {@link Throwable} of class <code>T</code> in the proper causal history
   * of the given <code>Throwable</code>, if one exists.
   *
  ...
  /**
   * Throws the most recent {@link Throwable} of class <code>T</code> in the (not necessarily
   * proper) causal history of the given <code>Throwable</code>, if one exists.
   *
   * @param cl the <code>Class</code> to search for
   * @param t the <code>Throwable</code> to check
   * @throws T if an ancestor of that class is found
