...
public class StartUp {
  ...
  protected void initHTTPProxyProperties() {
    ...
    if (System.getProperty(httpProxyHost) == null && System.getProperty(proxyHost) != null) {
    ...
    if (System.getProperty(httpProxyPort) == null && System.getProperty(proxyPort) != null) {
  ...
  public void setUIFont(
      ...
      javax.swing.plaf.FontUIResource fItalic,
      javax.swing.plaf.FontUIResource fBold,
      javax.swing.plaf.FontUIResource fBoth) {
    ...
    while (keys.hasMoreElements()) {
      ...
      if (value instanceof javax.swing.plaf.FontUIResource) {
        ...
        UIManager.put(
            key,
            fonty.getStyle() == Font.ITALIC
                ? fItalic
                : fonty.getStyle() == Font.BOLD
                    ? fBold
                    : fonty.getStyle() == (Font.BOLD | Font.ITALIC) ? fBoth : f);
      }
    }
  }
  ...
  protected void initUIProperties() {
    ...
    try {
      ...
      ErrorDialog.show(e, "Error.assistive_technology_not_found");
    }
          ...
          () -> {
            ...
            if (!SystemUtils.IS_OS_WINDOWS) {
              ...
              if ("com.sun.java.swing.plaf.gtk.GTKLookAndFeel"
                  .equals(UIManager.getLookAndFeel().getClass().getName())) { // NON-NLS
            ...
            final String fontString =
                ReadOnlyPrefs.getGlobalPrefs().getStoredValue(Prefs.OVERRIDE_DEFAULT_FONT_SIZE);
            try {
              final int fontSize = Integer.parseInt(fontString);
              if (fontSize > 0) {
                setUIFont(
                    new javax.swing.plaf.FontUIResource(
                        "SansSerif", Font.PLAIN, Math.max(8, Math.min(fontSize, 32))),
                    new javax.swing.plaf.FontUIResource(
                        "SansSerif", Font.ITALIC, Math.max(8, Math.min(fontSize, 32))),
                    new javax.swing.plaf.FontUIResource(
                        "SansSerif", Font.BOLD, Math.max(8, Math.min(fontSize, 32))),
                    new javax.swing.plaf.FontUIResource(
                        "SansSerif", Font.BOLD | Font.ITALIC, Math.max(8, Math.min(fontSize, 32))));
              }
