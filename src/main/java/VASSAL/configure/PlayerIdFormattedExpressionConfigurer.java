...
public class PlayerIdFormattedExpressionConfigurer extends FormattedExpressionConfigurer {
  ...
  public PlayerIdFormattedExpressionConfigurer(
      String[] options, String initialValue, GamePiece piece) {
  ...
  public PlayerIdFormattedExpressionConfigurer(String key, String name, String[] options) {
    ...
    final String[] allOptions =
        ArrayUtils.addAll(
            new String[] {
              GlobalOptions.PLAYER_NAME, GlobalOptions.PLAYER_SIDE, GlobalOptions.PLAYER_ID
            },
            options);
