...
public class NamedKeyManager {
   ...
   */
  protected static final int NAMED_START = 0xE000;
  protected static final int NAMED_END = 0xF8FE;
  ...
  public KeyStroke getKeyStroke(String name, KeyStroke ks) {
    ...
    return strokes.computeIfAbsent(name, k -> KeyStroke.getKeyStroke(getNextStroke(), 0));
  }
