...
public class ImageItem extends Item {
  ...
  public static final String SRC_VARIABLE =
      "Specified in individual images"; // NON-NLS - Yes really!
  ...
  public Class<?>[] getAttributeTypes() {
    return ArrayUtils.insert(2, super.getAttributeTypes(), Image.class, TextItem.TextSource.class);
  }

  @Override
  public String[] getAttributeNames() {
    return ArrayUtils.insert(2, super.getAttributeNames(), IMAGE, SOURCE);
  }
  ...
  protected static final class BaseOp extends AbstractTileOpImpl {
    ...
    public BufferedImage eval() {
      final BufferedImage img = ImageUtils.createCompatibleTranslucentImage(10, 10);
  ...
  public String encode() {
    ...
    se1.append(imageName).append(imageSource);
