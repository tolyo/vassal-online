...
public class PNGDecoderTest {
  ...
  public void testDecodeSignatureOk() throws IOException {
    ...
    final DataInputStream in = new DataInputStream(new ByteArrayInputStream(sig));
  ...
  public void testDecodeChunkBadLength() {
    final byte[] chunk = {(byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff};
